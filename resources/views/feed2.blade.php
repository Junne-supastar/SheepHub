...
<body>
  <aside class="sidebar">
    ...
    <nav>
      <ul>
        <br><br>
        <li><img src="{{ asset('img/home.png') }}" alt="" class="icones"><a href="feed2.html" id="iconescuro">Feed</a></li>
        <br>
      ...
      <section class="feed">
        <div class="post">
          ...
          <div class="post-header">
            <img src="{{ asset('img/clara.png') }}" alt="User Avatar">
            <div class="post-info">
              <span class="username">Clara Silva</span>
              <span class="handle">@aclarasilva</span>
              <p class="hoje">Hoje o culto foi transformador. Com certeza foi um divisor de águas!</p>
            </div>
          </div>
          <br>
          <div class="post-content">
            <div class="post-images">
              <img src="{{ asset('img/principal.png') }}" alt="Imagem 1" class="principal">
              <div>
                <img src="{{ asset('img/cima.png') }}" alt="Imagem 2" class="duas" id="cima">
                <img src="{{ asset('img/baixo.png') }}" alt="Imagem 3" class="duas" id="baixo">
              </div>
            </div>
          </div>
          <div class="post-footer">
            <ul class="intera">
              <li><img src="{{ asset('img/curti.png') }}" alt="" class="mini">1k</li>
              <li><img src="{{ asset('img/comenta.png') }}" alt="" class="mini">56</li>
              <li><img src="{{ asset('img/compartilha.png') }}" alt="" class="mini">502</li>
            </ul>
          </div>
        </div>
  ...
  <script src="{{ asset('js/feed2.js') }}"></script>
</body>
</html>
