...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/perfil-membro.css">
    <script src="/assets/js/perfil-membro.js" defer></script>
</head>
<body>
        ...
        <main class="banner-principal">
            <div class="circle-perfil">
                <img src="/assets/img/perfil-membro.jpg" alt="Foto de perfil do membro">
            </div>
        </main>
                ...
                <div class="lado1">
                    <div class="text-lado1">
                        ...
                        <div class="informacoes-base">
                            <span>
                                <img src="/assets/img/vetor03-perfil.svg" alt="">
                                <p>Entrou em Junho 2020</p>
                            </span>
                            <span>
                                <img src="/assets/img/vetor01-perfil.svg" alt="">
                                <p>Rio de Janeiro</p>
                            </span>
                            <span>
                                <img src="/assets/img/vetor02-perfil.svg" alt="">
                                <p>26/06/2003</p>
                            </span>
                        </div>
                    </div>
        ...
        <div class="container-post">
            <a href="#">
                <div class="post" id="post01">
                    <img src="/assets/img/img01-perfil-membro.png" alt="">
                </div>
            </a>
            <a href="#">
                <div class="post" id="post02">
                    <img src="/assets/img/img02-perfil-membro.png" alt="">
                </div>
            </a>
            <a href="#">
                <div class="post" id="post03">
                    <img src="/assets/img/img03-perfil-lider.png" alt="">
                </div>
            </a>
            <a href="#">
                <div class="post" id="post04">
                    <img src="/assets/img/img04-perfil-membro.png" alt="">
                </div>
            </a>
            <a href="#">
                <div class="post" id="post05">
                    <img src="/assets/img/img05-perfil-membro.png" alt="">
                </div>
            </a>
            <a href="#">
                <div class="post" id="post06">
                    <img src="/assets/img/img06-perfil-membro.png" alt="">
                </div>
            </a>
            <a href="#">
            ...
            <a href="#">
                <div class="post" id="post08">
                    <img src="/assets/img/img08-perfil-membro.png" alt="">
                </div>
            </a>
            <a href="#">
                <div class="post" id="post01">
                    <img src="/assets/img/img03-perfil-membro.png" alt="">
                </div>
            </a>
            <a href="#">
                <div class="post" id="post02">
        ...
        <div class="container-marcados">
            ...
            <article class="post-marcado">
                ...
                <header class="post-header">
                    ...
                    <a href="#" class="post-link-perfil">
                        <img src="img/img05-perfil-membro.png" alt="foto perfil" class="post-avatar">
                    </a>
                ...
                <div class="post-corpo">
                    <a href=""><img src="img/img04-perfil-membro.png" alt="Foto marcada" class="post-imagem"></a>
                </div>
            ...
            <article class="post-marcado">
                ...
                <header class="post-header">
                    ...
                    <a href="#" class="post-link-perfil">
                        <img src="img/img03-perfil-membro.png" alt="foto perfil" class="post-avatar">
                    </a>
                ...
                <div class="post-corpo">
                    <a href="#"><img src="img/img02-perfil-membro.png" alt="Foto marcada" class="post-imagem"></a>
                </div>
            ...
            <article class="post-marcado">
                ...
                <header class="post-header">
                    ...
                    <a href="#" class="post-link-perfil">
                        <img src="img/img07-perfil-membro.png" alt="foto perfil" class="post-avatar">
                    </a>
                ...
                <div class="post-corpo">
                    <a href="#"><img src="img/img07-perfil-membro.png" alt="Foto marcada" class="post-imagem"></a>
                </div>
            ...
            <article class="post-marcado">
                ...
                <div class="post-corpo">
                    <a href="#"><img src="img/img05-perfil-membro.png" alt="Foto marcada" class="post-imagem"></a>
                </div>
