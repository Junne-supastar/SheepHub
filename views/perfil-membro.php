...
<body>
                ...
                <header class="cabecalho">
                    ...
                    <div class="acoes-cabecalho">
                        ...
                        <p style="font-size: 0.8rem; color: var(--cor-texto-secundario)">Membro</p>
                                 ...
                                 <img src="/SheepHub/views/assets/uploads/<?= $perfil['foto_perfil'] ?>" alt="Foto de perfil do membro">
                        </div>
                    </div>
                </header>
 ...
 <!-- <main class="banner-principal">
    <img src="/SheepHub/views/assets/uploads/<?= $perfil['foto_fundo'] ?>" alt="Banner do perfil" class="banner-fundo">
    <div class="circle-perfil">
        <img src="/SheepHub/views/assets/uploads/<?= $perfil['foto_perfil'] ?>" alt="Foto de perfil do membro">
    </div> -->
</main> 
                    ...
                    <div class="text-lado1">
                         <div class="nome-usuario">
                            ...
                            <div class="descricao-container">
                                <p class="descricao"><?= htmlspecialchars($perfil['biografia']) ?></p>
                            </div>
