...
<head>
    ...
    <link rel="stylesheet" href="assets/css/perfil-lider.css">
    <script src="assets/js/perfil-lider.js" defer></script>
</head>
<body>
        ...
        <main class="banner-principal">
            <div class="circle-perfil">
                <img src="img/perfil-lider.png" alt="Foto de perfil do membro">
            </div>
        </main>
                ...
                <div class="lado1">
                    <div class="text-lado1">
                        ...
                        <div class="informacoes-base">
                            <span>
                                <img src="img/vetor03-perfil.svg" alt="">
                                <p>Entrou em Maio de 2020</p>
                            </span>
                            <span>
                                <img src="img/vetor01-perfil.svg" alt="">
                                <p>Rio de Janeiro</p>
                            </span>
                            <span>
                                <img src="img/vetor02-perfil.svg" alt="">
                                <p>24/03/2000</p>
                            </span>
                        </div>
                    </div>
        ...
        <div class="container-post">
            <a href="#">
                <div class="post" id="post01">
                    <img src="img/img01-perfil-lider.png" alt="">
                </div>
            </a>
            <a href="#">
                <div class="post" id="post02">
                    <img src="img/img02-perfil-lider.png" alt="">
                </div>
            </a>
            <a href="#">
                <div class="post" id="post03">
                    <img src="img/img03-perfil-lider.png" alt="">
                </div>
            </a>
            <a href="#">
                <div class="post" id="post04">
                    <img src="img/img06-perfil-lider.png" alt="">
                </div>
            </a>
            <a href="#">
                <div class="post" id="post05">
                    <img src="img/img05-perfil-lider.png" alt="">
                </div>
            </a>
            <a href="#">
            ...
            <a href="#">
                <div class="post" id="post07">
                    <img src="img/img07-perfil-lider.png" alt="">
                </div>
            </a>
            <a href="#">
                <div class="post" id="post08">
                    <img src="img/img08-perfil-lider.png" alt="">
                </div>
            </a>
            <a href="#">
                <div class="post" id="post01">
        ...
        <div class="container-marcados">
            ...
            <article class="post-marcado">
                ...
                <header class="post-header">
                    ...
                    <a href="#" class="post-link-perfil">
                        <img src="img/img05-perfil-lider.png" alt="foto perfil" class="post-avatar">
                    </a>
                ...
                <div class="post-corpo">
                    <a href=""><img src="img/img04-perfil-lider.png" alt="Foto marcada" class="post-imagem"></a>
                </div>
            ...
            <article class="post-marcado">
                ...
                <header class="post-header">
                    ...
                    <a href="#" class="post-link-perfil">
                        <img src="img/img03-perfil-lider.png" alt="foto perfil" class="post-avatar">
                    </a>
            ...
            <article class="post-marcado">
                ...
                <header class="post-header">
                    ...
                    <a href="#" class="post-link-perfil">
                        <img src="img/img07-perfil-lider.png" alt="foto perfil" class="post-avatar">
                    </a>
            ...
            <article class="post-marcado">
                ...
                <header class="post-header">
                    ...
                    <a href="#" class="post-link-perfil">
                        <img src="img/img08-perfil-lider.png" alt="foto perfil" class="post-avatar">
                    </a>
                ...
                <div class="post-corpo">
                    <a href="#"><img src="img/img05-perfil-lider.png" alt="Foto marcada" class="post-imagem"></a>
                </div>
