...
// Função para formatar a data de criação (opcional)
        ...
        <header class="cabecalho">
            ...
            <div class="acoes-cabecalho">
                <div class="info-perfil">
                 ...
                 <img src="/SheepHub/views/assets/uploads/<?= htmlspecialchars($perfilCompleto['foto_perfil'] ?? 'default.png') ?>" 
                    ...
                    <div class="lado1">
                        <div class="text-lado1">
                            ...
                            <div class="descricao-container">
                                <p class="descricao"><?= htmlspecialchars($perfilCompleto['descricao']) ?></p>
                            </div>
