...
require_once __DIR__ . '/../controllers/PerfilVisitanteController.php';

// Cria a conexão PDO
$pdo = Conexao::getConexao();

// Instancia o model e o controller
$model = new PerfilVisitante($pdo);
$controller = new PerfilVisitanteController($model);

// Busca dados do usuário logado
$idusuario = $_SESSION['idusuario'];
$perfil = $controller->model->getPerfilCompleto($idusuario);

if (!$perfil) {
    header("Location: /SheepHub/rotas/cadastro-perfil-visitante-salvar.php");
    exit;
}

// Define imagens padrão caso não existam
$foto_perfil = !empty($perfil['foto_perfil']) ? $perfil['foto_perfil'] : 'default-avatar.png';
$foto_fundo = !empty($perfil['foto_fundo']) ? $perfil['foto_fundo'] : 'default-banner.jpg';
...
<head>
    ...
    <title>Perfil Visitante</title>
    <link rel="stylesheet" href="/SheepHub/views/assets/css/perfil-membro.css">
    <script src="/SheepHub/views/assets/js/perfil-visitante.js" defer></script>
</head>
<body>
    <div class="container-geral">
        <aside id="menu-lateral" class="menu-lateral">
            ...
            <nav>
                ...
                <a href="#" class="link-navegacao ativo"><span>Meu perfil</span></a>
        ...
        <div class="conteudo-principal">
                ...
                <div class="acoes-cabecalho">
                    <div class="info-perfil">
                        <div class="texto-perfil">
                            <p><strong><?= htmlspecialchars($perfil['nome'] ?? '') ?></strong></p>
                            <p style="font-size: 0.8rem; color: var(--cor-texto-secundario)">Visitante</p>
                        </div>
                        <img src="/SheepHub/views/assets/uploads/<?= $foto_perfil ?>" alt="Foto do visitante">
                    </div>
                </div>
            </header>

            <main class="banner-principal" 
                style="background-image: url('/SheepHub/views/assets/uploads/<?= $foto_fundo ?>');">
            ...
            <div class="descricao-perfil">
                <div class="descricao-geral-perfil-visitante">
                    <div class="lado1">
                        <div class="text-lado1">
                            <div class="nome-usuario">
                                <h2><?= htmlspecialchars($perfil['nome'] ?? '') ?></h2>
                                <p>@<?= htmlspecialchars($perfil['username'] ?? '') ?></p>
                            </div>
                            ...
                            <div class="informacoes-base">
                                <span>
                                    ...
                                    <p>Entrou em <?= formatarMesAno($perfil['dt_criacao'] ?? '') ?></p>
                                </span>
                                <span>
                                    <img src="/SheepHub/views/assets/img/vetor01-perfil.svg" alt="">
                                    <p><?= htmlspecialchars($perfil['cidade'] ?? 'Não informada') ?></p>
                                </span>
                                <span>
                                    <img src="/SheepHub/views/assets/img/vetor02-perfil.svg" alt="">
                                    <p><?= isset($perfil['data_nascimento']) ? date('d/m/Y', strtotime($perfil['data_nascimento'])) : 'Não informado' ?></p>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="text-lado2">
                            <div class="metricas-perfil">
                                <div class="metricas-item01">
                                    <p class="metrica-numero">12</p>
                                    <p class="metrica-rotulo">Seguindo</p>
                                </div>
                                <div class="metricas-item02">
                                    <p class="metrica-numero">8</p>
                                    <p class="metrica-rotulo">Seguidores</p>
                                </div>
                            </div>
                            <a href="editar-perfil-visitante.php"><button>Editar perfil</button></a>
                        </div>
                    </div>
            ...
            <div class="tab-content" id="perfil">
                <div class="container-post">
                    <a href="#"><div class="post"><img src="/SheepHub/views/assets/img/img01-perfil-membro.png" alt=""></div></a>
                    <a href="#"><div class="post"><img src="/SheepHub/views/assets/img/img02-perfil-membro.png" alt=""></div></a>
                    <a href="#"><div class="post"><img src="/SheepHub/views/assets/img/img03-perfil-membro.png" alt=""></div></a>
                </div>
            </div>
