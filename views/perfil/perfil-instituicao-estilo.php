...
<head>
    ...
    <title>Estilizar Perfil Instituição</title>
    <link rel="stylesheet" href="/SheepHub/views/assets/css/perfilEstilo.css">
    <link href="https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css" rel="stylesheet">
</head>
<body>
<section class="container">
    <form class="card" action="/SheepHub/rotas/perfil-instituicao-salvar.php" method="post" enctype="multipart/form-data">
        ...
        <div class="input-container">
            <input type="text" name="descricao" maxlength="150" placeholder="Descrição breve da instituição">
            <input type="url" name="redes_sociais" placeholder="Link da instituição">
        </div>

        <button type="submit" class="btn-finalizar">Finalizar</button>
        <a href="/SheepHub/views/perfil-lider.php" class="link-estilizar">Estilizar depois</a>
    </form>
</section>
