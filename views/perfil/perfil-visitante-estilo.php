...
<head>
    ...
    <title>Estilizar Perfil Visitante</title>
    <link rel="stylesheet" href="/SheepHub/views/assets/css/perfilEstilo.css">
    <link href="https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css" rel="stylesheet">
</head>
<body>
<section class="container">
    <form class="card" action="/SheepHub/rotas/perfil-visitante-salvar.php" method="post" enctype="multipart/form-data">
    ...
    <input type="text" name="descricao" maxlength="150" placeholder="Descrição breve sobre você">
    <input type="text" name="redes_sociais" placeholder="Link das suas redes sociais">
</div>

        <button type="submit" class="btn-finalizar">Finalizar</button>
        <a href="/SheepHub/views/perfil-visitante.php" class="link-estilizar">Estilizar depois</a>
    </form>
</section>
